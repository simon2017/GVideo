...
public class ViewFunctions {
    private static String TAG = "VIDEO_FUNCTIONS";
     ...
     */
    public static void configureTransform(int viewWidth, int viewHeight, AutoFitTextureView mTextureView, Size mPreviewSize, Activity activity) {
